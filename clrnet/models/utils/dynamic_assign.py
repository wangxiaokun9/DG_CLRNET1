...
from clrnet.models.losses.laneiou_loss import laine_iou
from clrnet.models.losses.laneiou_loss_new import dynamic_line_iou
from clrnet.models.losses.GLIoU_loss import gline_iou
from clrnet.models.losses.G_Laiou_loss import g_laine_iou
...
def assign(
    ...
    # iou = gline_iou(predictions[..., 6:], targets[..., 6:], img_w, aligned=False)
    
    # # 计算IoU时使用动态宽度
    # iou = laine_iou(predictions[..., 6:], targets[..., 6:], 
    #     img_w=img_w,
    #     prior_ys=prior_ys,
    #     img_h=img_h,
    #     base_length=15,
    ...
    # iou = g_laine_iou(predictions[..., 6:], targets[..., 6:], 
    #     img_w=img_w,
    #     prior_ys=prior_ys,
    #     img_h=img_h,
    #     base_length=15,
    ...
    # iou = dynamic_line_iou(predictions[..., 6:], targets[..., 6:], 
    #                     img_w=img_w, 
    #                     img_h=img_h,  # 需要确保img_h可用
    #                     aligned=False)
