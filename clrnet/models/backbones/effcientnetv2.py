...
class EfficientNetv2Wrapper(nn.Module):
    def __init__(self,
                 ...
                 pretrained=True,
                 cfg=None):
        super(EfficientNetv2Wrapper, self).__init__()
        self.cfg = cfg
...
class EfficientNetV2(nn.Module):
    def __init__(self,
        ...
        self.part1 = nn.Sequential(*self.blocks[:10])
        self.part2 = nn.Sequential(*self.blocks[10:16])
        self.part3 = nn.Sequential(*self.blocks[16:])  
...
def efficientnetv2_s(num_classes: int = 1000, pretrained=True, **kwargs):
    """
    EfficientNetV2
